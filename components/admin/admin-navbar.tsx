...
import { Shield, LayoutDashboard, Play, Gamepad2, Users, LogOut, Menu, X, Settings } from "lucide-react"
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href="/admin" className="flex items-center space-x-3">
            ...
            <span className="text-xl font-bold font-mono">
              ...
              <span className="text-xs text-muted-foreground ml-2 font-sans">Admin</span>
            </span>
          </Link>
