  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        "rounded-xl overflow-hidden", // Simplified to rounded corners instead of complex clip-path
        "before:absolute before:inset-0 before:bg-gradient-to-r",
        "before:from-transparent before:via-white/3 before:to-transparent", // Reduced shimmer intensity
        "before:translate-x-[-100%] hover:before:translate-x-[100%]",
        "before:transition-transform before:duration-700",
        "shadow-lg", // Added base shadow for depth
        sizeClasses[size],
    ...
    >
      <div className="absolute inset-0 opacity-5">
        <div
          ...
          `,
            backgroundSize: "15px 15px", // Smaller grid for better scale
          }}
        />
      </div>
